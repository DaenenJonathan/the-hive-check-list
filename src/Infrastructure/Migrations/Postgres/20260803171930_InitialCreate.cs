        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedDepartureTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    PlannedReturnTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    ...
                    ReturnValidated = table.Column<bool>(type: "boolean", nullable: false),
                    ReturnValidatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReturnValidatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityPrepared = table.Column<int>(type: "integer", nullable: false),
                    QuantityReturned = table.Column<int>(type: "integer", nullable: true),
